...
const Enzp = require('../Models/Enzo.js');
...
const { Enzo } = require('../../../PmsAPIModule/pmsapi/Models/index.js');
    ...
    try {
        ...
        return app.render(template, values, async (err, content) => {
            ...
            try {
                ...
                if (values.email && values.email.toLowerCase().includes('gonzalez')) await sendEmailRequest(type, content, values.email, mailTrackingObj.messageId, attach);
            } catch (e) {
